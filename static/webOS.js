...
! function() {
    if (webOS.platform = {}, window.PalmSystem)
        if (navigator.userAgent.indexOf("SmartWatch") > -1) webOS.platform.watch = !0;
        else if (navigator.userAgent.indexOf("SmartTV") > -1 || navigator.userAgent.indexOf("Large Screen") > -1) webOS.platform.tv = !0;
        else {
            try {
                ...
                if (e.platformVersionMajor && e.platformVersionMinor) {
                    ...
                    3 > t || 3 == t && 0 >= o ? webOS.platform.legacy = !0 : webOS.platform.open = !0
                }
            } catch (i) {
...
function() {
    webOS.fetchAppId = function() {
        return window.PalmSystem && PalmSystem.identifier ? PalmSystem.identifier.split(" ")[0] : void 0
        ...
        return window.PalmSystem && PalmSystem.platformBack ? PalmSystem.platformBack() : void 0
    }
}(),
function() {
        ...
        if (webOS && webOS.platform && webOS.platform.watch) {
            ...
            s = function(e) {
                webOS.service.request("luna://com.webos.settingsservice", {
                                      ...
                                      t = o.settings.localeInfo.locales.TTS, e()
                                      },
                                      onFailure: function(e) {
            ...
            n = function(e) {
                webOS.service.request("luna://com.webos.settingsservice", {
                                      ...
                                      onSuccess: function(t) {
                                      o = Number(t.settings.ttsSpeechRate), e()
                                      },
                                      onFailure: function(e) {
