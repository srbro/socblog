import Vue from 'vue'
import Event from 'src/components/Detail/Event'
...
describe('Event.vue', () => {
  ...
  it('should display live event flag', () => {
    expect(vm.$el.querySelector('.live-flag').parentElement.style.display.length).to.equal(0)
  })
})
