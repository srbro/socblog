...
const buildVersion = args[4] || config.defaultBuildVersion
const versionUri = `../version.json`
const builder = {
  buildVersion
}
var webpackConfig = process.env.NODE_ENV === 'testing'
  ? require('./webpack.prod.conf')({platform, provider, server, buildVersion, versionUri, measure, builder})
  : require('./webpack.dev.conf')({platform, provider, server, buildVersion, versionUri, measure, builder})
